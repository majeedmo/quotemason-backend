...
price_fill -> draft -> END). The three-stage drafting pipeline mirrors how an
estimator works — applicable codes, then quantities, then prices — and each
